...
/* package usingquickcheck-0.1.0.0 */
#define VERSION_usingquickcheck "0.1.0.0"
#define MIN_VERSION_usingquickcheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "usingquickcheck-0.1.0.0-HUbvJGOjTQ3EVHFh0YZNRv"

#define CURRENT_PACKAGE_KEY "usingquickcheck-0.1.0.0-HUbvJGOjTQ3EVHFh0YZNRv"
