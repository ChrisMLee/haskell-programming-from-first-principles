...
/* package wordnumbers-0.1.0.0 */
#define VERSION_wordnumbers "0.1.0.0"
#define MIN_VERSION_wordnumbers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "wordnumbers-0.1.0.0-7IO8zslV8ZRJQ0h50lSU49"

#define CURRENT_PACKAGE_KEY "wordnumbers-0.1.0.0-7IO8zslV8ZRJQ0h50lSU49"
